...
interface ChatRepository {
    ...
    suspend fun completeOpenAIChat(question: Message, history: List<Message>, systemPromptOverride: String? = null): Flow<ApiState>
    suspend fun completeAnthropicChat(question: Message, history: List<Message>, systemPromptOverride: String? = null): Flow<ApiState>
    suspend fun completeGoogleChat(question: Message, history: List<Message>, systemPromptOverride: String? = null): Flow<ApiState>
    suspend fun completeGroqChat(question: Message, history: List<Message>, systemPromptOverride: String? = null): Flow<ApiState>
    suspend fun completeOllamaChat(question: Message, history: List<Message>, systemPromptOverride: String? = null): Flow<ApiState>
    suspend fun completeBedrockChat(question: Message, history: List<Message>, systemPromptOverride: String? = null): Flow<ApiState>
    suspend fun completeCustomChat(question: Message, history: List<Message>, systemPromptOverride: String? = null): Flow<ApiState>
